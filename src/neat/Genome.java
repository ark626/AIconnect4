...
public class Genome implements Serializable, Comparable<Genome> {
    ...
    private static final double MutateConnectionsChance = 0.25;//0.03;//0.25;
    private static final double PerturbChance = 0.90;
    private static final double LinkMutationChance = 0.2;//0.03;//2.0;
    private static final double NodeMutationChance = 0.5;//0.01;//0.50;
    ...
    private static final double EnableMutationChance = 0.2;// 0.4

	...
	//	int turns = z.getTurns();
		...
		if(hasWon){
			...
			if(z.pool != null){
				...
				z.receivefeedback((1000+chips+z.pool.Species.get(z.pool.currentSpecies-1).Genomes.get(z.pool.currentGenome-1).getFitness()));//+chips
					}
			...
			z.receivefeedback(z.ki.fitness-chips);
					...
					if(z.pool != null){
				z.receivefeedback((-chips-1000+z.pool.Species.get(z.pool.currentSpecies-1).Genomes.get(z.pool.currentGenome-1).getFitness()));
					}

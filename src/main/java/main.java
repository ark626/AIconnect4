        ...
        while (2 > 1) {
            ...
            for (int i = 0; i < Integer.parseInt(args[0]); i++) {
                if (i % 1000 == 0) {
                    ...
                    System.out.println("Run: " + i + " Iteration: " + Iteration + " Iterating: " + args[0] + " Batching: " + args[1] + " Runtime: " + (System.currentTimeMillis() - round) / 1000
                            + " Iterationtime: " + (System.currentTimeMillis() - it) / 1000 + " Total: " + (System.currentTimeMillis() - started) / 1000);
                    System.out.println("Total: " + total + " used " + used + " best Fitness:" + a.h.getPool().getTopfitness() + " maxfit: " + a.h.getPool().maxFitness);
            ...
            // Umgestellt
            // Genome te =
            // a.pool.Species.get(a.pool.currentSpecies-1).Genomes.get(a.pool.currentGenome-1);
            ...
            for (Species s : p.Species) {
                for (Genome ge : s.Genomes) {
                    ...
                    try {
                        ...
                        aiAlgorithmes.neat.visualizer.visualize(ge, "/var/www/PICTURES/HyperGenerator/Generator Species " + null1 + Spec + " Genome " + null2 + Genome);
                        test.generateweigths(ge);
                        visualizer.visualize(test, "/var/www/PICTURES/Hyper/HN Species " + null1 + Spec + " Genome " + null2 + Genome, p.Species.indexOf(s), s.Genomes.indexOf(ge));
                    } catch (Exception e) {
                        // TODO Auto-generated catch block
                        e.printStackTrace();
                    }
            ...
            content = Iteration + " ; " + best.getFitness() + " ; " + (System.currentTimeMillis() - started) / 1000;
            // Write data
            if (file2 != null) {
                FileWriter fw;
                try {

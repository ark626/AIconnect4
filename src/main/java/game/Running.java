...
public class Running implements Runnable {
	...
	public Running(Game g, int i, KICluster k, Pool p, Pool p2, int a, int b, gameDisplay dis, int minfit,
			HyperNeat hyper1, HyperNeat hyper2) {
		this.game = g;
		this.i = i;
		test = k;
		this.dis = dis;
	...
	public boolean dowhile(int currentround, int i) {
		...
		if (game.a.Playertype == 3 && game.a.pool.Species.get(game.a.pool.currentSpecies - 1).Genomes
				.get(game.a.pool.currentGenome - 1).getFitness() > tempfit) {
			tempfit = game.a.pool.Species.get(game.a.pool.currentSpecies - 1).Genomes.get(game.a.pool.currentGenome - 1)
					.getFitness();
		}
		if (game.b.Playertype == 3 && game.b.pool.Species.get(game.b.pool.currentSpecies - 1).Genomes
				.get(game.b.pool.currentGenome - 1).getFitness() > tempfit) {
			tempfit = game.b.pool.Species.get(game.b.pool.currentSpecies - 1).Genomes.get(game.b.pool.currentGenome - 1)
					.getFitness();
		}
	...
	public void run() {
		...
		try {
			...
			if (game.a.Playertype == 3) {
				content = "Playera: " + "NEAT " + " Playerb Strength: " + game.b.Playerstrength + " Playerb Type: "
						+ game.b.Playertype + " Started at: " + time2 + " ms" + " for " + this.i + " Rounds "
						+ " minfit: " + this.minfit + "\n";
			...
			if (game.b.Playertype == 3) {
				content = "Playerb: " + "NEAT " + " Playera Strength: " + game.a.Playerstrength + " Playera Type: "
						+ game.a.Playertype + " Started at: " + time2 + " ms" + " for " + this.i + " Rounds "
						+ " minfit: " + this.minfit + "\n";
			...
			if (game.a.Playertype == 0) {
				content = "Playera: " + "KI Cluster " + " Playerb Strength: " + game.b.Playerstrength
						+ " Playerb Type: " + game.b.Playertype + " Started at: " + time2 + " ms" + " for " + this.i
						+ " Rounds " + " minfit: " + this.minfit + "\n";
				path += "Normal/Playera.txt";
				file = new File(path);
			}

			if (game.b.Playertype == 0) {
				content = "Playerb: " + "KI Cluster " + " Playera Strength: " + game.a.Playerstrength
						+ " Playera Type: " + game.a.Playertype + " Started at: " + time2 + " ms" + " for " + this.i
						+ " Rounds " + " minfit: " + this.minfit + "\n";
...
//		
			...
			int Gen = 0;
			int Spec = 0;
			// System.out.println(game.a.Playertype+" "+game.b.Playertype+"
			// "+game.a.Playerstrength+" "+game.b.Playerstrength);
			if (game.a.Playertype == 3) {
				...
				System.out.println("Best Genome in Player a is in Species :" + Spec + " Genome: " + Gen
						+ " with Fitness of: " + p.getbest().getFitness());
			...
			if (game.b.Playertype == 3) {
				...
				System.out.println("Best Genome in Player b is in Species :" + Spec + " Genome: " + Gen
						+ " with Fitness of: " + p2.getbest().getFitness());
			...
			if (this.loadedtype1 == 1 || this.loadedtype2 == 1) {
				...
				try {
					for (int i = 0; i < test.ranking.size(); i++) {
						aiAlogrithmes.ki.visualizer.visualize(test.ranking.get(i), "C:/tmp/Normal/GLaDoS" + i);
					}
